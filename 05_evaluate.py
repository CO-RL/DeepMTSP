...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=['MTSP_9', 'MTSP_12', 'MTSP_15', 'MTSP_30'],
    )
    parser.add_argument(
        '-g', '--gpu',
    ...
    elif args.problem == 'MTSP_12':
        instances += [{'type': 'small', 'path': f"data/instances/{args.problem}/transfer_12_3/instance_{i+1}.lp"} for i in range(20)]
        instances += [{'type': 'medium', 'path': f"data/instances/{args.problem}/transfer_15_3/instance_{i+1}.lp"} for i in range(20)]
        instances += [{'type': 'big', 'path': f"data/instances/{args.problem}/transfer_18_3/instance_{i+1}.lp"} for i in range(20)]
    elif args.problem == 'MTSP_15':
        instances += [{'type': 'small', 'path': f"data/instances/{args.problem}/transfer_15_3/instance_{i+1}.lp"} for i in range(20)]
        instances += [{'type': 'medium', 'path': f"data/instances/{args.problem}/transfer_18_3/instance_{i+1}.lp"} for i in range(20)]
        instances += [{'type': 'big', 'path': f"data/instances/{args.problem}/transfer_21_3/instance_{i+1}.lp"} for i in range(20)]
    elif args.problem == 'MTSP_30':
        instances += [{'type': 'small', 'path': f"data/instances/{args.problem}/transfer_30_5/instance_{i+1}.lp"} for i in range(20)]
        instances += [{'type': 'medium', 'path': f"data/instances/{args.problem}/transfer_40_5/instance_{i+1}.lp"} for i in range(20)]
        instances += [{'type': 'big', 'path': f"data/instances/{args.problem}/transfer_50_5/instance_{i+1}.lp"} for i in range(20)]
    else:
        raise NotImplementedError
